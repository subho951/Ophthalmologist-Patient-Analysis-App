            ...
            <div class="info-box">
                <table style="width: 100%; border-collapse: collapse;">
                    ...
                    <tr>
                        ...
                        <td valign="top" style="width: 100%; text-align: left; font-family: sans-serif; display: block;">
                            <p class="value" style="width: 100%; text-align: left; font-family: sans-serif; display: block;"><?=date_format(date_create($test_report->diagnosis_date), "d/m/Y")?> <?=date_format(date_create($test_report->created_at), "h:i A")?></p>
                        </td>
                    </tr>
                </table>
            </div>
